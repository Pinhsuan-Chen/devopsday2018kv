    ...
    return {
        ...
        getSessionWithSpeaker: function () {
            return $.when(this.getSession(), this.getSpeaker()).then(function (Session, Speaker) {
                ...
                //         var sTime = leftPadZero(sDate.getMonth() + 1, 2) + '-' + leftPadZero(sDate.getDate(), 2) + ' ';
                //         sTime = sTime + leftPadZero(sDate.getHours(), 2) + ':' + leftPadZero(sDate.getMinutes(), 2);
